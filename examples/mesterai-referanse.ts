...
// Prøvekjøringer skal ikke havne på dashbordet: skriv dem et annet sted med --ut.
const utSti = tekstFlagg("ut", "trening-felles/mesterai-referanse.json");
