...
test("rekkefølgen bærer noe nytt: identiske aggregater gir IDENTISKE 996-trekk og ULIKE 1040-trekk", () => {
  ...
  const t1040a = troTrekkForBredde(MLB_TRO_INN_HS3, ekte, s.giving.antallStikk, 100, bok);
  const t1040b = troTrekkForBredde(MLB_TRO_INN_HS3, snudd, s.giving.antallStikk, 100, bok);
...
test("breddene: 1040 = 996 + 44, og kolonnekartet legger auksjonen BAKERST", () => {
  ...
  assert.equal(MLB_TRO_INN_HS3, 1040);
...
test("nullpunktet: et 996-trohode utvidet til 1040 gir NØYAKTIG samme tro; en koblet kolonne endrer den", () => {
  ...
  const ny = new MlbTronett(utvidTronett(rå, MLB_TRO_INN_HS3));
  ...
  const plantet = utvidTronett(rå, MLB_TRO_INN_HS3);
