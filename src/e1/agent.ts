...
import { e1SpillTrekk, E1_SPILL_DIM, E1_SPILL_DIM_V2, E1_SPILL_DIM_V3, E1_SPILL_DIM_V4, E1_SPILL_DIM_V5, E1_SPILL_DIM_V6 } from "./trekk.ts";
  ...
  if (
    ...
    throw new Error(
      `E1: nettet tar ${første.inn} trekk, men trekkuttrekket gir ${E1_SPILL_DIM} (v1), ` +
        `${E1_SPILL_DIM_V2} (v2), ${E1_SPILL_DIM_V3} (v3), ${E1_SPILL_DIM_V4} (v4), ${E1_SPILL_DIM_V5} (v5) eller ${E1_SPILL_DIM_V6} (v6)`,
    );
  }
