...
export * from "./bot/bot.ts"; // inkl. velgHandling, BotAgent (anytime/pondering), MAKS_STYRKE
export {
  løsDD,
  rotVerdier,
  evaluerHybrid,
...
export { trekkVerden, trekkVerdenBelief, byggDDOppsett, infererRenonce, type Verden } from "./solver/sampler.ts";
